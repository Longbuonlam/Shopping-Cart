...
{ 
	...
	printf("\n\n\t******************"
		...
		"Page****************"
		"*\n\n"); 
    printf("\tBEFORE START: -Please Enter the strong password, Your password must contain atleast one uppercase,Lowercase, Number and special character \n");
    printf("\t              -Your password must between 8 to 12\n");
    printf("\t              -Your phone number must be 10 digits\n ");
	printf("\t              -Your email must contain @ character!\n \n");
